...
![获取QQ音乐产品的下载地址](./screenshot/downloadQQMusic.png)
...
![获取歌单分类](./screenshot/getSongListCategories.png)
...
![获取歌单列表](./screenshot/getSongLists.png)
...
![获取歌单列表](./screenshot/batchGetSongLists.png)

**获取歌单列表-带参数**

![获取歌单列表-带参数](./screenshot/getSongLists-params.png)
...
![获取歌单详情](./screenshot/getSongListDetail.png)
...
![获取MV标签](./screenshot/getMvByTag.png)
...
![获取MV播放信息](./screenshot/getMvPlay.png)
...
![获取歌手MV - default](./screenshot/getSingerMv-default.png)

![获取歌手MV - belong](./screenshot/getSingerMv-listen.png)

![获取歌手MV - fans](./screenshot/getSingerMv-time.png)
...
![获取歌手热门歌曲](./screenshot/getSingerHotsong.png)
...
![获取相似歌手](./screenshot/getSimilarSinger.png)
...
![获取歌手信息](./screenshot/getSingerDesc.png)
...
![获取歌手列表](./screenshot/getSingerList.png)
...
![获取歌手被关注数量信息](./screenshot/getSingerStarNum.png)
...
![获取电台列表](./screenshot/getRadioLists.png)
...
![获取专辑](./screenshot/getAlbumInfo.png)
...
![获取数字专辑](./screenshot/getDigitalAlbumLists.png)
...
![获取歌曲歌词 - 未格式化](./screenshot/getLyric.png)

![获取歌曲歌词 - 格式化](./screenshot/getLyric-parse.png)
...
![获取新碟信息](./screenshot/getNewDisks.png)
...
![获取歌手专辑](./screenshot/getSingerAlbum.png)
...
![获取歌曲相关信息](./screenshot/getSongInfo.png)
...
![获取歌曲相关信息](./screenshot/batchGetSongInfo.png)
...
![获取歌曲VKey](./screenshot/getMusicVKey.png)
...
![获取搜索热词](./screenshot/gethotkey.png)
...
![获取获取关键字搜索提示](./screenshot/getSmartbox.png)
...
![获取获取搜索结果](./screenshot/getSearchByKey.png)
...
![获取首页推荐](./screenshot/getRecommend.png)
...
![获取排行榜单列表](./screenshot/getTopLists.png)
...
![获取排行榜单详情](./screenshot/getRanks.png)
...
![获取评论信息 - id获取](./screenshot/getComments-id.png)

![获取评论信息](./screenshot/getComments.png)

![获取评论信息 - 带params](./screenshot/getComments-param.png)
...
![获取歌曲id](./screenshot/get-song-id.png)

![获取歌曲图片地址](./screenshot/get-song-image.png)

![歌曲图片地址](./screenshot/song-image.png)

![获取专辑id](./screenshot/get-song-album-id.png)

![获取歌曲专辑地址](./screenshot/get-album-image.png)

![歌曲专辑地址](./screenshot/album-image.png)
...
![获取票务信息](./screenshot/getTicketInfo.png)
